...
public:
	 ...
	 * IMPORTANT: Using unique_ptr so we can control destruction order explicitly.
	 * Must be destroyed BEFORE the endpoint is closed. Memory registrations
	 * must be deregistered before closing the endpoint. */
